---
layout: post
title: Ironsworn - Mira - A call to Iron part 6
date: 2026-05-01
categories: letsplay
...
> *We'll try again to secure advantage through daily prayers with our **Devotant** asset, we'll be making a travel move next and I could really use the boost.*
...
> *A good place to burn momentum, we get the +1 on the travel move and I get to add 2 momentum straight back into the pot.*
...
> *Mira has never been to Abon before, so usually we'd treat this mechanically as **Undertaking a Journey**. However, I've framed this in the fiction as Mira retracing her steps for part of the journey and then following a well-worn trade road regularly patrolled by Wardens which leads all the way to the settlement. Instead of starting a journey tracker I'm going to use the **Follow a Path** move which was added as part of the Lodestar reference guide. This allows us to resolve the journey in a single roll, which means we can pile on the advantages and weight the roll as much in our favour as possible while also leaving the possiblity of something going horribly wrong.*
...
> *I think those two troubles can be combined quite handily. In light of these results we are going to retcon the scene of Mira's arrival a little. I wanted to leave this in because it happens all the time in my Ironsworn games and I want to show the process warts-and-all.*

> *First, rather than not seeing anyone for the last hour, we are going to say that she saw no-one coming from the city for the whole day she was travelling there. If she had met someone coming from the city they would surely have stopped her and told her about the sickness, so this just makes sense. Secondly, the arrival scene at the gate will look a little different.*
...
> *Are we going to follow her advice and head back home? Hell no! But we are going to try and get some more information out of this Warden, so we should roll up some details for this NPC.*
...
> *Let's get an idea of who is knocking. This will help us envision the beginning of this interaction.*
...
> *The next section is going to jump around a bit as we keep referring back to oracle tables to see where the conversation goes. You can approach this in lots of different ways. I like to envision and write out the whole conversation but sketching out a few bullet points also works perfectly well.*
...
> *I had a look through the Ironsworn and Delve books for ideas and I have two candidates. Number one is an Elder beast, and number two is a Blighthound. Neither creature as-written causes this kind of illness, but both have magical ties to the land and would be easy enough to weave in. We'll let the dice decide, if and when Mira gathers enough information to identify one or the other. Right now it's all hearsay.*
...
> *OK, one last Oracle roll to see if we end on a cliffhanger.*
